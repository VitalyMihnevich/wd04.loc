            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{route('article.index')}}" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Статьи</span> </a>
                        </li>
                        <li>
                            <a href="{{route('country.index')}}" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Страны</span> </a>
                        </li>
                        <li>
                            <a href="{{route('category.index')}}" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Категории товара</span> </a>
                        </li>

                        <li>
                            <a href="{{route('product.index')}}" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Товары</span> </a>
                        </li>
